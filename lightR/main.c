...
int main(void)
{
    ...
    for(;;)
    {
        ...
        if (value <= 200) {P3OUT |= BIT5;} else {P3OUT &= ~BIT5;}
        if (value <= 300) {P6OUT |= BIT4;} else {P6OUT &= ~BIT4;}
        if (value <= 400) {P6OUT |= BIT3;} else {P6OUT &= ~BIT3;}
        if (value <= 500) {P7OUT |= BIT4;} else {P7OUT &= ~BIT4;}
        if (value <= 600) {P3OUT |= BIT7;} else {P3OUT &= ~BIT7;}
        if (value <= 700) {P8OUT |= BIT1;} else {P8OUT &= ~BIT1;}
